...
const Home = () => {
    return <>
        ...
        <div className='leading-[60px]'>
            <h3 className='text-[#505050] text-[18px] sm:text-[20px] whitespace-nowrap uppercase tracking-wider font-bold'>Devops Engineer</h3>
            <h1 className='text-[39.063px] sm:text-[48.828px] font-semibold uppercase tracking-wider'>Anant Jakhmola</h1>
            <button className='text-primary-red text-[20px] mt-[25px] cursor-pointer group flex gap-[25px] items-center'>
            ...
            <NavLink  
                to='/about'
                className='text-[#615F5F] text-[20px] cursor-pointer group flex gap-[25px] items-center'>
